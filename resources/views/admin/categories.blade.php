            ...
            <div>
              ...
              <div>
                ...
                <div class="flex justify-between border-t text-sm font-normal  mt-4  space-x-4">
                  ...
                  <form class="px-2" action="/deleteCategory/{{$category->id}}" method="POST">
                    @csrf
                    @method('DELETE')
                      <button  type="submit"
                ...
                <div class="relative p-4 w-full max-w-md max-h-full">
                  <div class="relative py-4 px-5 bg-white rounded-lg shadow dark:bg-gray-700 right-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 ">
                    <form class="" method="POST" action="/updateCategory/{{ $category->id }}">
                        ...
                        @method('PUT')
                        <div class="relative">
                            <label for="statu" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">update category</label>
                            <input name="title" id="statu"  type="text"
