...
<div class="min-h-screen bg-purple-100">
          ...
          <li>
            <a class="" href="#">
              <button class="middle none font-sans font-bold center transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none text-xs py-3 rounded-lg text-white hover:bg-white/10 active:bg-white/30 w-full flex items-center gap-4 px-4 capitalize" type="button">
                ...
                <p class="block antialiased font-sans text-base leading-relaxed text-inherit font-medium capitalize">archive</p>
              </button>
            </a>
          </li>
          <li>
          ...
          <li>
            <a class="" href="#">
              <button class="middle none font-sans font-bold center transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none text-xs py-3 rounded-lg text-white hover:bg-white/10 active:bg-white/30 w-full flex items-center gap-4 px-4 capitalize" type="button">
                ...
                <p class="block antialiased font-sans text-base leading-relaxed text-inherit font-medium capitalize">damandes</p>
              </button>
            </a>
          </li>
    ...
    <div class="p-4 xl:ml-80">
      ...
      <div class="mt-12 bg-gray-50 min-h-screen">
              ...
              <div>
                ...
                <div>
                  ...
                  <div class="flex justify-between border-t text-sm font-normal  mt-4  space-x-4">
                    ...
                    <div class="px-16 py-2 flex flex-row items-center">
                        <img
                    ...
                    <div class="px-2">
                        <button id="button{{ $event->id }}" onclick="toggleModal('progress-modal{{ $event->id }}', 'button{{ $event->id }}')"
                            class="font-medium text-purple-600 dark:text-blue-500 hover:underline">Edit</button> 
                    </div>
                  </div>


                  <div id="progress-modal{{ $event->id }}"
                    ...
                    <div class="relative p-4 w-full max-w-md max-h-full">
                      ...
                      <div class="relative py-4 px-5 bg-white rounded-lg shadow dark:bg-gray-700 right-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 ">
                        ...
                        <form class="" method="POST" action="/accepte/event/{{ $event->id }}">
                            @csrf
                            @method('PUT')
                            <div class="relative">
                                ...
                                <select name="status" id="statu"
                                    ...
                                    <option value="1" {{ $event->status === '1' ? 'selected' : '' }}>refuser</option>
                                    <option value="0" {{ $event->status === '0' ? 'selected' : '' }}>accepter</option>
                                </select>
                            </div>
