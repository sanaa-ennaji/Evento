    ...
    <aside class="bg-purple-800 -translate-x-80 fixed inset-0 z-50   h-[100vh] w-72  transition-transform duration-300 xl:translate-x-0">
      ...
      <div class="m-4">
        <ul class="mb-4 flex flex-col gap-1">
          <li>
            <a aria-current="page" class="active" href="/creator/statistique">
          ...
          <li>
            <a class="" href="/creator/reservations">
              <button class="middle none font-sans font-bold center transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none text-xs py-3 rounded-lg text-white hover:bg-white/10 active:bg-white/30 w-full flex items-center gap-4 px-4 capitalize" type="button">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" class="w-5 h-5 text-inherit">
              ...
              <div>
                ...
                <div>
                  ...
                  <div class="flex justify-between border-t text-sm font-normal  mt-4  space-x-4">
                    ...
                    <div class="px-2">
                      <span>{{$reservation->is_validated}}</span>
                    </div>
                    <div class="px-2">
                  ...
                  <div id="progress-modal{{  $reservation->id  }}"
                    ...
                    <div class="relative p-4 w-full max-w-md max-h-full">
                      ...
                      <div class="relative py-4 px-5 bg-white rounded-lg shadow dark:bg-gray-700 right-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 ">
                        ...
                        <form class="" method="POST" action="/accepte/reservation/{{ $reservation->id }}">
                            @csrf
                            @method('PUT')
                            <div class="relative">
                                <label for="statu" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">acceptation</label>
                                <select name="is_validated" id="statu"
