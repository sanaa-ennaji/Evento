      ...
      <div class="flex flex-wrap -m-4 text-center">
        <div class="p-4 sm:w-1/4 w-1/2">
          <div class="bg-indigo-500 rounded-lg p-2 xl:p-6">
              <h2 class="title-font font-medium sm:text-4xl text-3xl text-white">{{ $numberOfEvents }}</h2>
              <p class="leading-relaxed text-gray-100 font-bold">events</p>
          </div>
        </div>
        <div class="p-4 sm:w-1/4 w-1/2">
          <div class="bg-indigo-500 rounded-lg p-2 xl:p-6">
              <h2 class="title-font font-medium sm:text-4xl text-3xl text-white">{{ $numberOfReservations }}</h2>
              <p class="leading-relaxed text-gray-100 font-bold">Reservations</p>
          </div>
